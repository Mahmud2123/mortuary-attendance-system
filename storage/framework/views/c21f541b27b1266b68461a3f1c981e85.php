    ...
    <div class="col-md-6">
        <div class="card">
            <div class="card-body">
                ...
                <form class="row g-2 mb-3" method="GET" action="<?php echo e(route('reports.admissions')); ?>" target="_blank">
    ...
    <div class="col-md-6">
        <div class="card">
            <div class="card-body">
                ...
                <form class="row g-2" method="GET" action="<?php echo e(route('reports.attendance')); ?>" target="_blank">
                    <div class="col-6"><input type="date" name="from" class="form-control form-control-sm"></div>
                    <div class="col-6"><input type="date" name="to" class="form-control form-control-sm"></div>
                    <div class="col-12 d-flex gap-2 mt-2">
                        <button class="btn btn-sm btn-outline-primary" onclick="this.form.format.value='pdf'">PDF</button>
    ...
    <div class="col-md-6">
        <div class="card">
            <div class="card-body">
                ...
                <form class="d-flex gap-2" method="GET" action="<?php echo e(route('reports.chambers')); ?>" target="_blank">
                    <button class="btn btn-sm btn-outline-primary" onclick="this.form.format.value='pdf'">PDF</button>
                    <button class="btn btn-sm btn-outline-secondary" onclick="this.form.format.value='csv'">CSV</button>
                    <input type="hidden" name="format" value="pdf">
                </form>
    ...
    <div class="col-md-6">
        <div class="card">
            <div class="card-body">
                ...
                <form class="row g-2" method="GET" action="<?php echo e(route('reports.releases')); ?>" target="_blank">
                    <div class="col-6"><input type="date" name="from" class="form-control form-control-sm"></div>
                    <div class="col-6"><input type="date" name="to" class="form-control form-control-sm"></div>
                    <div class="col-12 d-flex gap-2 mt-2">
                        <button class="btn btn-sm btn-outline-primary" onclick="this.form.format.value='pdf'">PDF</button>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mortuary\resources\views/reports/index.blade.php ENDPATH**/ ?>